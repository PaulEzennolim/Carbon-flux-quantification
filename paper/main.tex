...
% \renewcommand{\shortauthors}{Ezennolim et al.}   % NAMED running header -- restore for camera-ready
...
% =====================================================================
%% RESTORE for camera-ready: the acknowledgments name the supervisor (Po Yang)
%% and would de-anonymise the submission, so they are commented out for the
%% double-blind version. Uncomment this whole block for the named camera-ready.
% \begin{acks}
